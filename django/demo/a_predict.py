...
class Model:
	def __init__ (self):
		self.model_type = load_model('./demo/Result/Arduino_first_layer.h5')
		self.model_dynamic = load_model('./demo/Result/Arduino_second_layer_dynamic.h5')
		self.model_static = load_model('./demo/Result/Arduino_second_layer_static.h5')
